...
if [ -f /usr/local/src/systemd_nspawn.env ];then
  ...
  if [[ $(id $USER -u) -eq 0 ]];then
    #rootユーザー
    PS1="\[\e[38;5;118m\]\u\[\e[m\] \[\e[38;5;195m\]ukijumotahaneniarukenia\e[m\] \[\e[1;37m\]\H\[\e[m\] \[\e[38;5;213m\]\t\[\e[m\] \[\e[38;5;157m\]\w\[\e[m\]\[\e[1;33m\]$\[\e[m\]"
  else
    #non-rootユーザー
    PS1="\[\e[38;5;195m\]\u\[\e[m\] \[\e[38;5;118m\]ukijumotahaneniarukenia\e[m\] \[\e[1;37m\]\H\[\e[m\] \[\e[38;5;213m\]\t\[\e[m\] \[\e[38;5;157m\]\w\[\e[m\]\[\e[1;33m\]$\[\e[m\]"
  fi
else
