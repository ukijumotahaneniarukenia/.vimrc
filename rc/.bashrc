...
alias randU=$HOME/script_scratch/shuf/ランダムな半角大文字取得.sh
alias randn=$HOME/script_scratch/shuf/ランダムな半角数字取得.sh
alias randan=$HOME/script_scratch/shuf/ランダムな半角英数字取得.sh
alias randUu=$HOME/script_scratch/shuf/ランダムな半角大文小文字取得.sh
alias randu=$HOME/script_scratch/shuf/ランダムな半角小文字取得.sh
